...
const AdminDashboard = ({ onPageChange }) => {
  ...
  const stats = [
    ...
    { title: 'Total Revenue', value: `₹${mockOrders.reduce((sum, order) => sum + order.total, 0)}`, icon: TrendingUp, color: 'bg-yellow-500' },
          ...
          <div className="flex justify-between items-center py-4">
            ...
            <div className="flex items-center space-x-4">
              <span className="text-sm text-gray-500">
                Role: <span className="font-medium capitalize">{currentAdmin?.role}</span>
              </span>
              <button
                    ...
                    {mockOrders.map((order) => (
                      <tr key={order.id}>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <select 
                            value={order.status}
                            className="text-xs font-semibold rounded-full px-2 py-1 border-none focus:ring-2 focus:ring-green-500"
                          >
                            <option value="pending">Pending</option>
                            <option value="processing">Processing</option>
                            <option value="shipped">Shipped</option>
